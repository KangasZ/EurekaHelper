...
using EurekaHelperZ.System;
using EurekaHelperZ.Windows;
using EurekaHelperZ.XIV;
using EurekaHelperZ.XIV.Zones;

namespace EurekaHelperZ;
    public class EurekaHelper : IDalamudPlugin
    {
        public string Name => "Eureka Helper Z";
        ...
        public EurekaHelper(IDalamudPluginInterface pluginInterface)
        {
            ...
            WindowSystem = new("Eureka Helper Z");
